...
$categoryResponse    = $sg->client->categories()->stats()->get( null, $stats->getCategory( array( 'category1', 'category2' ) ) );
$categorySumResponse = $sg->client->categories()->stats()->sums()->get( null, $stats->getSum() );

$subuserResponse        = $sg->client->subusers()->stats()->get( null, $stats->getSubuser( array( 'user1', 'user2' ) ) );
